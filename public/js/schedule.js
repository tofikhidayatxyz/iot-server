...
function appendElement(data) {
  var obj = "<div class=\"w-100 bg-white shadow rounded list-schedule px-2 mt-2 schedule-".concat(data.id, "\" id=\"").concat(data.id, "\">\n\t\t\t\t<div class=\"time\">\n\t\t\t\t\t<p class=\"text-left mb-0 time text-primary __time mr-auto\">").concat(data.time, "</p>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"command px-2\">\n\t\t\t\t\t<p class=\"mb-0 text-truncate w-100 text-grey __command\">Turn <span class=\"action-name\">").concat(data.action, "</span> <span class=\"item-name\">").concat(data.target, "</span></p>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"action\">\n\t\t\t\t\t<button class=\"btn p-0 ml-1 text-warning btn-edit float-right\" data-id=\"").concat(data.id, "\">\n\t\t\t\t\t\t<i class=\"fa fa-edit\"></i>\n\t\t\t\t\t</button>\n\t\t\t\t\t<button class=\"btn p-0 ml-1 text-danger btn-delete float-right\" data-id=\"").concat(data.id, "\">\n\t\t\t\t\t\t<i class=\"fa fa-trash\"></i>\n\t\t\t\t\t</button>\n\t\t\t\t</div>\n\t\t\t</div>");

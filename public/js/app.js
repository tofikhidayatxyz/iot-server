...
function submitNewData() {
  ...
  if (newValidate(new_title, new_desc, new_access) == 0) {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_1__["default"].postData('/create/save', {
      name: new_title,
      access: new_access,
...
function callEntry() {
  ...
  document.querySelectorAll('.button-entry').forEach(function (item) {
    item.addEventListener('click', function () {
      _utils__WEBPACK_IMPORTED_MODULE_1__["default"].postData('/edit/switch', {
  ...
  document.querySelectorAll('.btn-view').forEach(function (item) {
    item.addEventListener('click', function () {
      _utils__WEBPACK_IMPORTED_MODULE_1__["default"].postData('/view', {
        id: item.getAttribute('data-id')
      }).then(function (data) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.close();
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire({
...
function update(id) {
  ...
  if (newValidate(title, desc, access) == 0) {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_1__["default"].postData('/edit/update', {
      id: id,
      name: title,
      access: access,
      description: desc
...
document.querySelector("#net-button").addEventListener('click', function (e) {
  document.querySelector('#stat-net').classList.toggle('hide');
  setTimeout(function () {
    document.querySelector('#stat-net').classList.add('hide');
  }, 5000);
});
document.querySelector("#stat-net-button").addEventListener('click', function (e) {
  document.querySelector('#stat-net').classList.add('hide');
});
document.querySelector("#client-button").addEventListener('click', function (e) {
  document.querySelector('#stat-client').classList.toggle('hide');
  setTimeout(function () {
    document.querySelector('#stat-client').classList.add('hide');
  }, 5000);
});
document.querySelector("#stat-client-button").addEventListener('click', function (e) {
  document.querySelector('#stat-client').classList.add('hide');
});

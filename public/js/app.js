...
(function () {
  ...
  setTimeout(function () {
    ...
    document.querySelectorAll('.list-data .card').forEach(function (item) {
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
              ...
              preConfirm: function () {
                var _preConfirm = _asyncToGenerator(
                /*#__PURE__*/
...
function submitNewData() {
  ...
  if (newValidate(new_title, new_desc, new_access) == 0) {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].postData('/create/save', {
      name: new_title,
      access: new_access,
...
function callEntry() {
  // switch
  document.querySelectorAll('.button-entry').forEach(function (item) {
    item.addEventListener('click', function () {
      //loading();
      document.querySelector('.loader-line').style.width = '50%';
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].postData('/edit/switch', {
  ...
  document.querySelectorAll('.btn-view').forEach(function (item) {
    item.addEventListener('click', function () {
      loading();
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].postData('/view', {
        id: item.getAttribute('data-id')
      }).then(function (data) {
        loadingStop();
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.close();
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
          ...
          html: "<form action='demo' enctype='multipart/form-data'>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller label</label>\n\t\t\t\t\t\t\t        <input type='text' value='".concat(data[0]['name'], "' class='swal2-input mt-1 mb-2 disabled bg-white border-0 px-0 ' disabled placeholder='Controller Label '>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller Access</label>\n\t\t\t\t\t\t\t        <input type='text' value='").concat(data[0]['access'], "' class='swal2-input mt-1 mb-2 disabled bg-white border-0 px-0' disabled placeholder='Controller Access '>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller Description</label>\n\t\t\t\t\t\t\t        <textarea class='swal2-input mt-1 mb-2 disabled bg-white border-0 px-0' disabled placeholder='Controller Description '>").concat(data[0]['description'], "</textarea>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller Status</label>\n\t\t\t\t\t\t\t        <input type='text' value='").concat(data[0]['status'], "' class='swal2-input mt-1 mb-2 disabled bg-white border-0 px-0' disabled placeholder='Controller Access '>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t</form>\n\t\t\t\t \t"),
          confirmButtonText: 'Ok',
          confirmButtonColor: 'var(--info)'
        });
      })["catch"](function (err) {
    ...
    item.addEventListener('click', function () {
      ...
      _utils__WEBPACK_IMPORTED_MODULE_2__["default"].postData('/view', {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
          ...
          html: "\n\t\t\t\t\t\t\t<form action='demo' id='form-edit-item' enctype='multipart/form-data'>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller label</label>\n\t\t\t\t\t\t\t        <input type='text' id='upd-label' class='swal2-input mt-1 mb-2' value='".concat(data[0]['name'], "' placeholder='Controller Label '>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller Access</label>\n\t\t\t\t\t\t\t        <input type='text' id='upd-access' class='swal2-input mt-1 mb-2' value='").concat(data[0]['access'], "' placeholder='Controller Access '>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t    <div class='form-group'>\n\t\t\t\t\t\t\t        <label for='' class='font-weight-bold mb-0 float-left text-left'>Controller Description</label>\n\t\t\t\t\t\t\t        <textarea id='upd-desc' class='swal2-textarea mt-1 mb-0' placeholder='Controller Description '>").concat(data[0]['description'], "</textarea>\n\t\t\t\t\t\t\t    </div>\n\t\t\t\t\t\t\t</form>\n\t\t\t\t \t\t"),
          showCancelButton: true,
          confirmButtonText: 'Save',
          cancelButtonText: 'Cancel',
          confirmButtonColor: 'var(--primary)',
  ...
  document.querySelectorAll('.btn-delete').forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      sweetalert2__WEBPACK_IMPORTED_MODULE_1___default.a.fire({
        ...
        loading();
        _utils__WEBPACK_IMPORTED_MODULE_2__["default"].postData('/delete', {
          id: item.getAttribute('data-id')
        }).then(function (result) {
...
function update(id) {
  var title = document.querySelector('#upd-label').value;
  var desc = document.querySelector('#upd-desc').value;
  var access = document.querySelector('#upd-access').value;
  ...
  if (newValidate(title, desc, access) == 0) {
    ...
    _utils__WEBPACK_IMPORTED_MODULE_2__["default"].postData('/edit/update', {
      id: id,
      name: title,
      access: access,
      description: desc
...
function filtrator(dom, db) {
  ...
  if (dom.length > db.length) {
    checker = _utils__WEBPACK_IMPORTED_MODULE_2__["default"].checker(dom, db);

    for (var i = 0; i < dom.length; i++) {
      for (var j = 0; j < checker.length; j++) {
        if (dom[i]['id'].toString() == checker[j].toString()) {
          var target = dom[i].crono;
          var env = document.querySelector('#' + target);
          env.parentNode.removeChild(env);
        }
      }
    }
  } else if (db.length > dom.length) {
    checker = _utils__WEBPACK_IMPORTED_MODULE_2__["default"].checker(db, dom);
...
setInterval(function (e) {
  ...
  _utils__WEBPACK_IMPORTED_MODULE_2__["default"].getData('/view/all', {}).then(function (result) {
